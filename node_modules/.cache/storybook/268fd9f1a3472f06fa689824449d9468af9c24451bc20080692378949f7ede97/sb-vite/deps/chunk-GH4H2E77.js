import {
  I
} from "./chunk-QE64D72K.js";
import {
  require_jsx_runtime
} from "./chunk-VSF7THHL.js";
import {
  require_react_dom
} from "./chunk-RPSARGFG.js";
import {
  require_react
} from "./chunk-5WM3L6AY.js";
import {
  require_global
} from "./chunk-E4Q3YXXP.js";
import {
  __commonJS,
  __require,
  __toESM
...
var an2;
var ei = C2(() => {
  an2 = (globalThis == null ? void 0 : globalThis.document) ? o5.useLayoutEffect : () => {
  };
});
function Om(e4, t) {
...
function c5(e4, t = []) {
  ...
  function n(i, c) {
    ...
    r = [...r, c];
    function u(d) {
      let { scope: m, children: v, ...y } = d, p = (m == null ? void 0 : m[e4][s]) || l, h4 = lt.useMemo(() => y, Object.values(y));
      return (0, import_jsx_runtime3.jsx)(p.Provider, { value: h4, children: v });
    }
    o2(u, "Provider");
    function f(d, m) {
      let v = (m == null ? void 0 : m[e4][s]) || l, y = lt.useContext(v);
      if (y) return y;
...
`
  ...
  Um = I3.forwardRef((e4, t) => {
    ...
    return o2(A, "handleDragScroll"), I3.useEffect(() => {
      let M4 = o2((L2) => {
        let P2 = L2.target;
        (y == null ? void 0 : y.contains(P2)) && E4(L2, x);
      }, "handleWheel");
...
function oi() {
  var _a2;
  return ((_a2 = no2.navigator) == null ? void 0 : _a2.clipboard) ? async (e4) => {
    var _a3;
    try {
      await ((_a3 = no2.top) == null ? void 0 : _a3.navigator.clipboard.writeText(e4));
    } catch {
  ...
  if (R) {
    if (i) {
      var D2, K2 = x === "y" ? te2 : ne2, T = x === "y" ? le2 : ae2, z2 = x === "y" ? "height" : "width", k2 = R[x], V2 = k2 + h4[K2], F = k2 - h4[T], j2 = v ? -A[z2] / 2 : 0, O = w === ut ? S[z2] : A[z2], G = w === ut ? -A[z2] : -S[z2], Ee2 = t.elements.arrow, pe2 = v && Ee2 ? Qt2(Ee2) : {
        ...
        S[z2],
        pe2[z2]
      ), Ot2 = b ? S[z2] / 2 - j2 - Se2 - ue - L2.mainAxis : O - Se2 - ue - L2.mainAxis, Yr2 = b ? -S[z2] / 2 + j2 + Se2 + ve2 + L2.mainAxis : G + Se2 + ve2 + L2.mainAxis, Xo = t.elements.arrow && et2(t.elements.arrow), pp = Xo ? x === "y" ? Xo.clientTop || 0 : Xo.clientLeft || 0 : 0, xl = (D2 = P2 == null ? void 0 : P2[x]) != null ? D2 : 0, mp = k2 + Ot2 - xl - pp, hp = k2 + Yr2 - xl, El = tr(v ? Jt2(V2, mp) : V2, k2, v ? Qe2(F, hp) : F);
      R[x] = El, _2[x] = El - k2;
    }
    if (l) {
      var Sl, gp = x === "x" ? te2 : ne2, vp = x === "x" ? le2 : ae2, Bt2 = R[E4], zn2 = E4 === "y" ? "height" : "width", Cl = Bt2 + h4[gp], Ml = Bt2 - h4[vp], Zo = [te2, ne2].indexOf(g) !== -1, Al = (Sl = P2 == null ? void 0 : P2[E4]) != null ? Sl : 0, Ll = Zo ? Cl : Bt2 - S[zn2] - A[zn2] - Al + L2.altAxis, Il = Zo ? Bt2 + S[zn2] + A[zn2] - Al - L2.altAxis : Ml, zl = v && Zo ? Uf(Ll, Bt2, Il) : tr(v ? Ll : Cl, Bt2, v ? Il : Ml);
...
function Vd(e4, t) {
  ...
  $2.useEffect(function() {
    ...
    function T(z2) {
      ...
      Fd.getBoundingClientRect = $d(k2, V2), R == null ? void 0 : R();
    }
...
function lu(e4, t = []) {
  ...
  function n(i, c) {
    ...
    let u = o2((d) => {
      var _a2;
      let { scope: m, children: v, ...y } = d, p = ((_a2 = m == null ? void 0 : m[e4]) == null ? void 0 : _a2[s]) || l, h4 = $e2.useMemo(() => y, Object.values(y));
      return (0, import_jsx_runtime6.jsx)(p.Provider, { value: h4, children: v });
    }, "Provider");
    u.displayName = i + "Provider";
    function f(d, m) {
      var _a2;
      let v = ((_a2 = m == null ? void 0 : m[e4]) == null ? void 0 : _a2[s]) || l, y = $e2.useContext(v);
      if (y) return y;
      if (c !== void 0) return c;
      throw new Error(`\`${d}\` must be used within \`${i}\``);
    }
...
var Ti = Q2.forwardRef(
  (e4, t) => {
    let {
      ...
      onDismiss: l,
      ...s
    } = e4, u = Q2.useContext(yu), [f, d] = Q2.useState(null), m = (f == null ? void 0 : f.ownerDocument) ?? (globalThis == null ? void 0 : globalThis.document), [, v] = Q2.useState({}), y = Xe2(t, (S) => d(
      S
      ...
      !x || M4 || (a == null ? void 0 : a(S), c == null ? void 0 : c(S), S.defaultPrevented || (l == null ? void 0 : l()));
    }, m), R = Sg((S) => {
      let A = S.target;
      [...u.branches].some((L2) => L2.contains(A)) || (i == null ? void 0 : i(S), c == null ? void 0 : c(S), S.defaultPrevented || (l == null ? void 0 : l()));
    }, m);
    return gu((S) => {
...
xg.displayName = Rg;
function Eg(e4, t = globalThis == null ? void 0 : globalThis.document) {
...
function Sg(e4, t = globalThis == null ? void 0 : globalThis.document) {
...
${t}`);
  ...
  return import_react27.default.createElement(import_react27.Fragment, null, import_react27.default.createElement("span", null, n), ": ", import_react27.default.createElement(
    ...
    (l, s) => (l == null ? void 0 : l.name) ? import_react27.default.createElement(import_react27.Fragment, { key: s }, "  ", "at ", import_react27.default.createElement(f3, null, l.name), " (", import_react27.default.createElement(wf, null, l.location), ")", import_react27.default.createElement("br", null)) : import_react27.default.createElement(
...
function op(e4) {
  let t = (0, import_react48.useRef)(), r = (0, import_react48.useRef)(), n = (0, import_react48.useRef)(/* @__PURE__ */ new Map()), { width: a = 1 } = Eo({
    ...
    let { x: m, width: v } = t.current.getBoundingClientRect(), { width: y } = r.current.getBoundingClientRect(), p = l.length ? m + v - y : m + v, h4 = [], g = 0, w = e4.filter((b) => {
      let { id: x } = b, E4 = n.current.get(x), { width: R = 0 } = (E4 == null ? void 0 : E4.getBoundingClientRect()) || {}, S = m + g + R > p;
...
//# sourceMappingURL=chunk-GH4H2E77.js.map
